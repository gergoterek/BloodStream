...
INSERT INTO donor (blood_type, donor_name, password, role, username, TAJ, id_card, birth_date, next_donation_date, male) VALUES
        ('A_NEG', 'Godeny Gyorrgy', '$2a$04$YDiv9c./ytEGZQopFfExoOgGlJL6/o0er0K.hiGb5TGKHUL8Ebn..',
         'ROLE_DONOR', 'donor', 423423113, '1D899R', '2009-03-23', CURRENT_TIMESTAMP(), 0);
...
INSERT INTO application (applied_date, donor_id, place_id, donation_id) VALUES ('2020-01-19', 1, 2,3);
INSERT INTO application (applied_date, donor_id, place_id, donation_id) VALUES ('2020-01-03', 1, 2,2);
INSERT INTO application (applied_date, donor_id, place_id, donation_id) VALUES ('2020-11-03', 1, 2,1);
--INSERT INTO application (applied_date, donor_id, place_id, donation_id) VALUES ('1997-12-12',  2,1,3);
INSERT INTO application (applied_date, donor_id, place_id, donation_id) VALUES ('2020-11-12', 5,2, null);
INSERT INTO application (applied_date, donor_id, place_id, donation_id) VALUES ('2020-11-12', 1,1, null);
...
INSERT INTO message (title, message, send_date, seen, donor_id, apply_id) VALUES ('Korabbi veradasa', 'Koszontjuk!', CURRENT_TIMESTAMP(), 0, 1, null);
...
INSERT INTO opening_time (place_id, monday, tuesday, wednesday, thursday, friday, saturday, sunday, start_time, closing_time) VALUES
        (1, 1, 1, 1, 1, 1, 1, 1, 450, 900);
INSERT INTO opening_time (place_id, monday, tuesday, wednesday, thursday, friday, saturday, sunday, start_time, closing_time) VALUES
        (2, 1, 1, 1, 1, 1, 1, 1, 600, 800);
